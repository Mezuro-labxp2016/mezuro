...
# Kalibro Processor
git clone https://github.com/mezuro/kalibro_processor.git -b v0.3.0 kalibro_processor
...
git clone https://github.com/mezuro/kalibro_configurations.git -b v0.0.1 kalibro_configurations
