...
# Kalibro Processor
git clone https://github.com/mezuro/kalibro_processor.git -b v0.4.0 kalibro_processor
...
git clone https://github.com/mezuro/kalibro_configurations.git -b v0.0.4 kalibro_configurations
